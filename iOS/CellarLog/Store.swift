...
final class Store: ObservableObject {
    ...
    private let fileName = "cellarlog_entries.json"
    ...
    static func seedData() -> [BottleEntry] {
        let now = Date()
        return [
            BottleEntry(title: "Sample Bottle One", detail1: "Example", detail2: "Example", note: "Tap + to add your own.", date: now),
            BottleEntry(title: "Sample Bottle Two", detail1: "Example", detail2: "Example", note: "", date: now.addingTimeInterval(-86400))
        ]
    }
}
